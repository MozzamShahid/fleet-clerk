...
const DriverDetailsPage = () => {
    const { driverId } = useParams();  // Ensure this correctly gets the driverId
    ...
    useEffect(() => {
        console.log("Driver ID:", driverId);  // This should show the actual driverId
        ...
        if (driverId) {
            ...
            const fetchProfileData = async () => {
                try {
                    ...
                    const carQuery = query(collection(db, "cars"), where("user_specific_id", "==", driverId));
                    ...
                    const maintenanceQuery = query(collection(db, "carMaintain"), where("user_specific_id", "==", driverId));
    ...
    if (!driverDetails) {
        return <div>No driver details found.</div>;
    }

    return (
        <div className='driver-profile bg-white p-5 rounded-lg shadow'>
